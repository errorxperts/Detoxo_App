...
**Architecture / code-quality review** of one module (layering, boundaries, SOLID, reuse, lint,
rebuild hygiene, measured scorecard) is `.claude/skills/detoxo-code-quality/SKILL.md`
(run **`/detoxo-code-quality`**).
